  ...
  $(document).ready(function() {
      ...
      function createImages() {
        ...
        var $imgs = window.IMGEN.map(function(image) {
          return $('<img src="' + image.url + '" alt="' + image.name + '"></img>');
        });
        ...
        container.on('click', 'img', function(e) {
          ...
          $imgs.each(function(index, item) {
            var $el = $(this);
            var isCurrentTarget = (this === e.currentTarget);
            $el.toggleClass('active', isCurrentTarget);
            if (isCurrentTarget) {
      ...
      function drawToCanvas() {
        ...
        reader.onloadend = function() {
          ...
          allFlagsImage.src = selectedImageUrl;
